...
/**
 * Construye los query params actuales preservando search y per_page.
 */
const buildParams = () => {
    const params = {}
...
<template>
    <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <!-- Header: busqueda + per page + slot para acciones -->
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                    ...
                    >
                        ...
                        <td v-if="allowActions" class="sticky whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                            ...
                            <button 
                                v-if="allowEdit"
                                @click="emit('edit', item)" title="Editar"
                            ...
                            <button 
                                v-if="allowDelete"
                                @click="emit('delete', item.id)" title="Eliminar"
