...
const emit = defineEmits(['create', 'edit', 'delete', 'restore', 'export_pdf', 'export_excel'])
...
<template>
    <div v-if="allowExports" class="flex justify-end items-center gap-2 bg-white border rounded-xl p-3">
        <!-- <span class="text-sm text-gray-600">Exportar registros</span> -->
        <!-- <slot name="filters" /> -->

        <button
            @click="emit('export_pdf')"
            title="Exportar a PDF"
            class="flex items-center gap-2 border border-red-400 bg-red-50 text-red-500 rounded-xl px-3 py-1 hover:bg-red-600 hover:text-white transition-colors"
            >
            ...
            <span class="text-sm font-medium pt-1">Exportar a PDF</span>
        </button>

        <button
            @click="emit('export_excel')"
            title="Exportar a PDF"
            class="flex items-center gap-2 border border-green-500 bg-green-50 text-green-600 rounded-xl px-3 py-1 hover:bg-green-600 hover:text-white transition-colors"
            >
            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                viewBox="0 0 1024 1024">
                <path
            ...
            <span class="text-sm font-medium pt-1">Exportar a Excel</span>
        </button>
    </div>
