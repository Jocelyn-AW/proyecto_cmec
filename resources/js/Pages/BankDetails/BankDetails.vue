                ...
                <div
                    ...
                    <div
                        ...
                        <!-- <button @click="openCreate"
                            class="inline-flex items-center gap-1.5 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-white/[0.03] shadow-sm transition-colors">
                        ...
                        <button @click="openCreate"
                            class="inline-flex items-center gap-1.5 rounded-lg border border-gray-300 dark:border-gray-700 bg-green-600 px-4 py-2 text-sm font-medium text-white dark:text-gray-300 hover:bg-green-700 shadow-sm transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                class="w-4 h-4">
                                <path
                                    d="M10.75 4.75a.75.75 0 00-1.5 0v4.5h-4.5a.75.75 0 000 1.5h4.5v4.5a.75.75 0 001.5 0v-4.5h4.5a.75.75 0 000-1.5h-4.5v-4.5z" />
                    ...
                    <div v-if="props.bankDetails.length > 0">
                        <div v-for="(item, index) in props.bankDetails" :key="item.id"
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <!-- numero de cuenta / CLABE enmascarada -->
                    ...
                    <div v-else class="flex flex-col items-center justify-center gap-3 py-16">
                        ...
                        <button @click="openCreate"
                            class="inline-flex h-10 shrink-0 justify-center items-center gap-2 rounded-lg bg-emerald-600 text-white px-4 text-sm font-medium hover:bg-emerald-700 transition-colors shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
