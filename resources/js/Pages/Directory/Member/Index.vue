                ...
                <div class="px-8 py-2">
                    <div v-for="(clinic, index) in formData.clinics" class="space-y-6 mt-4">
                        <div class="grid grid-cols-3 gap-3">
                            ...
                            <div>
                                <label
                                    class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Hospital</label>
                            ...
                            <div class="col-span-2">
                                <label
                                    class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Dirección</label>
                            ...
                            <div class="col-start-1">
                                <label
                                    class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Teléfono
                                    de contacto</label>
                            ...
                            <div class="col-span-2">
                                <label
                                    class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Horario</label>
