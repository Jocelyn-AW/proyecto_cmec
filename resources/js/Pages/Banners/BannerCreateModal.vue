...
const submit = async () => {
    ...
    router.post('/banners', formData, {
        ...
        onError: () => {
            emit('error', 'Error al crear el banner')
        },
        onFinish: () => {
        ...
        <div class="p-6 space-y-4">
            <div v-if="imagePreview" class="mb-4">
                ...
                <div class="w-full h-48 overflow-hidden rounded-lg border border-gray-300">
                    <img :src="imagePreview" class="w-full h-full object-cover" alt="Preview del nuevo banner">
                </div>
            </div>
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500">
                    Formato permitido: JPG, PNG, WEBP (Peso max. 1MB)
                </p>
            </div>
