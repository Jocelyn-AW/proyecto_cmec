    ...
    <tr>
        ...
        <td class="px-4 py-3 border border-gray-100 dark:border-white/[0.05]">
            <div class="flex items-center gap-3">
                ...
                <span class="font-medium text-gray-800 text-sm dark:text-white/90 whitespace-nowrap">
                    {{ user.name }}
                </span>
            </div>
        </td>
        ...
        <td class="px-4 py-3 border border-gray-100 dark:border-white/[0.05] text-center">
            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium capitalize" :class="user.role === 'administrador'
        ...
        <!-- estado/status -->
        <td class="px-4 py-3 border border-gray-100 dark:border-white/[0.05] text-center">
            <button @click="emit('status-change', user)"
