...
const submitImages = () => {
    ...
    router.post(route('conferences.gallery.update', props.conference.id), form, {
        forceFormData: true,
        onSuccess: () => {
            reset()
...
const deleteImage = (mediaId) => {
    hideAlert()
    router.delete(route('conferences.gallery.delete', {
...
<template>
    ...
    <div class="p-6 border-t border-gray-100 dark:border-gray-800 sm:p-6">
        <div class="space-y-5">
            <div class="">
                <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Galería del congreso: {{ conference.name }}</h3>
            ...
            <div @keydown="onKeydown" tabindex="-1">
                ...
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center gap-3">
                        <button @click="router.get(route('conferences.index'))" class="text-gray-500 hover:text-gray-700">
                            ← Volver
                        </button>
                    </div>
