    ...
    <article
        ...
        <div class="flex flex-col flex-1 p-5 gap-3">
            ...
            <div class="flex items-center justify-between">
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium capitalize" :class="item.type === 'noticia'
            ...
            <!-- titulo -->
            <h3 class="text-sm font-semibold text-gray-800 dark:text-white/90 line-clamp-2 leading-snug">
                {{ item.title }}
            </h3>
        ...
        <div class="flex items-center justify-between border-t border-gray-100 dark:border-gray-800 px-5 py-3">
            ...
            <button @click="emit('status-change', item)" :title="item.is_active ? 'Desactivar' : 'Activar'"
                ...
                <span class="w-1.5 h-1.5 rounded-full" :class="item.is_active ? 'bg-green-500' : 'bg-red-500'" />
                {{ item.is_active ? 'Activo' : 'Inactivo' }}
            </button>

            <!-- editar / eliminar -->
            <div class="flex items-center gap-2">
                <button title="Editar" @click="emit('edit', item)"
