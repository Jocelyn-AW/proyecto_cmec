...
const saveOrder = async () => {
    try {
        ...
        await axios.post('/publicity/reorder', payload)
...
const deletePost = (id) => {
    warning('¿Estás seguro de eliminar esta publicidad?', {
        ...
        cancelText: 'Cancelar',
        onConfirm: async () => {
            await axios.delete(`/publicity/${id}`)
...
const createPost = async () => {
    ...
    try {
        ...
        const response = await axios.post('/publicity', formData, {
            headers: {
        ...
        errorA('Error al crear la publicidad')
    } finally {
...
const openEditModal = (id) => {
    ...
    editForm.value = {
        ...
        link: post.link || '',
        order: post.order,
        currentImage: post.image // guardas la imagen actual
    }
...
const updatePost = async () => {
    ...
    try {
        ...
        const response = await axios.post(`/publicity/${editForm.value.id}`, formData, {
            headers: {
                'Content-Type': 'multipart/form-data'
            }
        })
        ...
        errorA('Error al actualizar la publicidad')
    } finally {
        isSubmitting.value = false
    }
}
    ...
    <div>
                                ...
                                <template #item="{ element, index }">
                                    <div :key="element.id"
                                        ...
                                        <div class="flex-shrink-0 flex items-center gap-2">
                                            ...
                                            <button @click="deletePost(element.id)" title="Eliminar"
        ...
        <Modal :show="showCreateModal" @close="closeCreateModal" maxWidth="2xl">
            ...
            <template #footer>
                ...
                <button @click="createPost" :disabled="isSubmitting || !createForm.image"
        ...
        <Modal :show="showEditModal" @close="closeEditModal" maxWidth="2xl">
            ...
            <template #footer>
                ...
                <button @click="updatePost" :disabled="isSubmitting"
