...
<template>
    <Modal :show="show" @close="close" maxWidth="2xl">
        ...
        <div class="p-6 space-y-4">
            <Dropzone
                :preview="diploma.preview.value"
                :is-dragging="diploma.isDragging.value"
                :accept="'application/pdf'"
                label="Arrastra tu PDF aqui o haz clic para seleccionar"
                hint="PDF (max. 5MB)"
                @change="diploma.handleChange"
                @drop="diploma.handleDrop"
                @drag-enter="diploma.handleDragEnter"
                @drag-leave="diploma.handleDragLeave"
