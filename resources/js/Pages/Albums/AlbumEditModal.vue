                ...
                <Transition enter-active-class="duration-200 ease-out"
                    ...
                    <div v-if="show" class="relative w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
                        ...
                        <div class="px-6 py-5 space-y-4">
                            ...
                            <!-- Info del álbum (pills informativas) -->
                            <div v-if="album" class="flex flex-wrap gap-2 pt-1">
                                <span
                                    class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-100 text-xs text-slate-500">
